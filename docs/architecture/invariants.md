...
| `CBN-INV-012` | `CBN-CONTRACT-012-SELECTION-CONSUMER-OWNED`  | Semantic board selection and destinations are consumer-owned; the provider may own only transient spare-source selection for accessible placement.                                                                         |
